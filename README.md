...
> **关于曲线**：以**首次购买日 2026-03-27** 为 0 起点（当时尚未提现到冷钱包）；横轴最右端为**目标日 2029-06-01**；纵轴固定 **0 → 0.1 BTC**，不按持仓放大；只画折线。  
> 手机 App 对 Mermaid 的支持可能弱于桌面网页。

---

<!-- AUTO-GENERATED:START -->
> 自动生成于 `2026-07-21 11:49` · 目标 **0.1 BTC** · 数据源 `data/transactions.csv`
...
xychart-beta
    ...
    x-axis ["26-03-27", "26-06-08", "29-06-01"]
    y-axis "BTC" 0 --> 0.1
    line [0.0, 0.005231, 0.1]
```

_起点为首次购买日 `2026-03-27`（累计 0，尚未提现到冷钱包）；横轴最右端为目标日 `2029-06-01`；纵轴固定 0 → 0.1 BTC（目标 **0.1 BTC**）。_
