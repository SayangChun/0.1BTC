...
> **关于曲线是否“看不见”**：只有 1 笔提现时，折线本身几乎没有“走势”；若纵轴固定拉到 0.1 BTC，早期持仓也会贴在底部。  
> 脚本会自动：① 补一个 0 起点；② 叠加柱状图；③ 早期按持仓放大纵轴。记录变多后曲线会更明显。手机 App 上 Mermaid 支持也可能弱于桌面网页。

---

<!-- AUTO-GENERATED:START -->
> 自动生成于 `2026-07-21 10:28` · 目标 **0.1 BTC** · 数据源 `data/transactions.csv`
...
xychart-beta
    ...
    x-axis ["26-06-07", "26-06-08"]
    y-axis "BTC" 0 --> 0.010462
    bar [0.0, 0.005231]
    line [0.0, 0.005231]
```

_纵轴当前按持仓放大显示（约 0 → 0.010462 BTC），便于观察早期增长；最终目标仍为 **0.1 BTC**。_
